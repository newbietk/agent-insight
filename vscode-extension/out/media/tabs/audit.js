...
exports.renderAuditTab = renderAuditTab;
exports.renderAuditJS = renderAuditJS;
...
<div id="tab-audit" class="tab-panel">
  ...
  <div id="auditEditor" style="flex:1;overflow-y:auto;padding:12px 16px">
    ...
    <div style="border:1px solid var(--border);border-radius:8px;padding:12px 16px;margin-bottom:16px;background:var(--card-bg);font-size:13px;line-height:1.6">
      <h3 style="font-size:15px;font-weight:600;color:var(--text);margin-bottom:6px">📋 ${(0, shared_1.escHtml)((0, i18n_1.t)('audit.title'))}</h3>
      <p style="font-size:13px;color:var(--text-dim);margin-bottom:8px;line-height:1.7">${(0, shared_1.escHtml)((0, i18n_1.t)('audit.description'))}</p>
      <ol style="font-size:13px;color:var(--text-dim);padding-left:24px;line-height:1.8">
        <li>${(0, shared_1.escHtml)((0, i18n_1.t)('audit.step1'))}</li>
        <li>${(0, shared_1.escHtml)((0, i18n_1.t)('audit.step2'))}</li>
        <li>${(0, shared_1.escHtml)((0, i18n_1.t)('audit.step3'))}</li>
      </ol>
    </div>

    <!-- Textarea -->
    <textarea id="auditTextarea"
      placeholder="${(0, shared_1.escHtml)((0, i18n_1.t)('audit.pastePlaceholder'))}"
    ...
    <div style="display:flex;gap:8px;margin-top:10px">
      <button id="auditRenderBtn" style="padding:8px 18px;font-size:13px;font-weight:500;border-radius:6px;background:var(--accent);color:#fff;border:none;cursor:pointer">${(0, shared_1.escHtml)((0, i18n_1.t)('audit.renderBtn'))}</button>
      <button id="auditDemoBtn" style="padding:8px 18px;font-size:13px;font-weight:500;border-radius:6px;background:var(--card-bg);color:var(--text);border:1px solid var(--border);cursor:pointer">${(0, shared_1.escHtml)((0, i18n_1.t)('audit.loadDemo'))}</button>
    </div>
  </div>
  ...
  <div id="auditChart" style="display:none;flex:1;overflow-y:auto">
    <div style="display:flex;align-items:center;justify-content:space-between;padding:8px 16px;border-bottom:1px solid var(--border);position:sticky;top:0;background:var(--bg);z-index:10">
      <span style="font-size:12px;color:var(--text-dim)">${(0, shared_1.escHtml)((0, i18n_1.t)('audit.storedAt'))}</span>
      <div style="display:flex;gap:8px">
        <button id="auditRepasteBtn" class="card-btn card-btn-sm">${(0, shared_1.escHtml)((0, i18n_1.t)('audit.repaste'))}</button>
        <button id="auditClearBtn" class="card-btn card-btn-sm">${(0, shared_1.escHtml)((0, i18n_1.t)('audit.clear'))}</button>
      </div>
    </div>
