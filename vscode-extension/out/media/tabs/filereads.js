...
exports.renderFileReadsTab = renderFileReadsTab;
exports.renderFileReadsJS = renderFileReadsJS;
const shared_1 = require("../shared");
const i18n_1 = require("../../i18n");
function renderFileReadsTab() {
    return `
<div id="tab-filereads" class="tab-panel">
  <div class="cards" id="filereadsCards"></div>
  <div class="table-wrap" style="margin-top:12px">
    <div class="table-header">
      ${(0, shared_1.escHtml)((0, i18n_1.t)('filereads.title'))}
      <span style="font-size:11px;color:var(--text-dim);font-weight:400;margin-left:8px">${(0, shared_1.escHtml)((0, i18n_1.t)('filereads.clickHint'))}</span>
    </div>
    <div style="max-height: 600px; overflow-y: auto;">
      <table>
        <thead><tr>
          <th>${(0, shared_1.escHtml)((0, i18n_1.t)('filereads.colFile'))}</th>
          <th>${(0, shared_1.escHtml)((0, i18n_1.t)('filereads.colReads'))}</th>
          <th>${(0, shared_1.escHtml)((0, i18n_1.t)('filereads.colWrites'))}</th>
          <th>${(0, shared_1.escHtml)((0, i18n_1.t)('filereads.colUniqueLines'))}</th>
          <th>${(0, shared_1.escHtml)((0, i18n_1.t)('filereads.colRedundancy'))}</th>
          <th>${(0, shared_1.escHtml)((0, i18n_1.t)('filereads.colLatestTurn'))}</th>
        </tr></thead>
...
//# sourceMappingURL=filereads.js.map