...
exports.renderSkillsTab = renderSkillsTab;
exports.renderSkillsJS = renderSkillsJS;
...
<div id="tab-skills" class="tab-panel">
  ...
  <div class="chart-container" style="margin-top:12px">
    <div class="chart-title">📊 ${(0, shared_1.escHtml)((0, i18n_1.t)('skills.timelineTitle'))}</div>
    <canvas id="skillsChart"></canvas>
  </div>
  <div class="table-wrap" style="margin-top:12px">
    <div class="table-header">${(0, shared_1.escHtml)((0, i18n_1.t)('skills.allEvents'))}</div>
    <div style="max-height: 500px; overflow-y: auto;">
      <table>
        <thead><tr>
          <th>${(0, shared_1.escHtml)((0, i18n_1.t)('skills.colSkill'))}</th>
          <th>${(0, shared_1.escHtml)((0, i18n_1.t)('skills.colTurn'))}</th>
          <th>${(0, shared_1.escHtml)((0, i18n_1.t)('skills.colEvent'))}</th>
          <th>${(0, shared_1.escHtml)((0, i18n_1.t)('skills.colStatus'))}</th>
          <th>${(0, shared_1.escHtml)((0, i18n_1.t)('skills.colDuration'))}</th>
          <th>${(0, shared_1.escHtml)((0, i18n_1.t)('skills.colAgent'))}</th>
        </tr></thead>
