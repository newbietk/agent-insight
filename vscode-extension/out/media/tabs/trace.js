...
<div id="tab-trace" class="tab-panel">
  ...
  <div class="chart-container" style="margin-top:12px">
    <div class="chart-title">${'📡 ' + (0, shared_1.escHtml)((0, i18n_1.t)('trace.propagationTitle'))}</div>
    <div id="tracePropagationView">
      <div class="empty-state"><div class="icon">🔗</div>${(0, shared_1.escHtml)((0, i18n_1.t)('trace.propagationEmpty'))}</div>
    </div>
  </div>
</div>`;
}
