...
interface StateMessage {
  command: 'setState';
  mode: 'welcome' | 'sessions' | 'welcome-expanded';
  sessions?: SessionItem[];
}

export class MainViewProvider implements vscode.WebviewViewProvider {
  public static readonly viewType = 'hismartlite.main';

  private _view?: vscode.WebviewView;
  private _mode: 'welcome' | 'sessions' | 'welcome-expanded' = 'welcome';
    ...
    webviewView.webview.onDidReceiveMessage(msg => {
      switch (msg.command) {
        ...
        case 'runTerminal': {
          ...
          const opts: vscode.TerminalOptions = { name: 'Context Insight' };
          if (cwd) { opts.cwd = cwd; }
