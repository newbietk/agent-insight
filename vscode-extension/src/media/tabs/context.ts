...
export function renderContextTab(): string {
  return `
<div id="tab-context" class="tab-panel">
  <div class="chart-container">
    <div class="chart-title">${escHtml(t('context.title'))}</div>
    <div id="contextBars"></div>
  </div>
  <div class="ctx-summary" id="ctxSummary">
    <div class="ctx-summary-title">${escHtml(t('context.summary'))}</div>
    <div class="ctx-summary-grid" id="ctxSummaryGrid"></div>
  </div>
</div>`;
}

export function renderContextJS(): string {
  return `
// ── Context Growth Bars ──
