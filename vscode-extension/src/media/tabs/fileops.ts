...
export function renderFileOpsTab(): string {
  return `
<div id="tab-fileops" class="tab-panel">
  ...
  <div class="fileops-layout">
    <div class="fileops-timeline" id="fileopsTimeline">
      <div class="empty-state"><div class="icon">📁</div><div>${escHtml(t('fileops.loading'))}</div></div>
    </div>
    <div class="fileops-detail" id="fileopsDetail">
      <div class="empty-state"><div class="icon">📋</div><div>${escHtml(t('fileops.selectTurnHint'))}</div></div>
    </div>
  </div>
</div>`;
}

export function renderFileOpsJS(): string {
  return `
