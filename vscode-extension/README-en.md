# Context Insight - VSCode Extension
...
3. Click the **graph icon** (📊) in the activity bar to open the Context Insight panel

### Import Sessions

1. In the Context Insight sidebar, click the **cloud-download** icon (📥)
...
This produces `context-insight-<version>.vsix` in the current directory.
